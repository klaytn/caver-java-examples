 ...
 * Related article - Korean: https://medium.com/klaytn/caver-java-dynamic-abi-loader-8ccef10e7e68 <br>
...
public class BoilerPlate {
    ...
    public static void run() {
        try {
            ...
            // Dynamic ABI Loader related source codes...
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
